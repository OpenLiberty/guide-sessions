...
To demostrate how HTTP session data can be shared in multiple instances of the same application,
this guide will show you to build an application that requires to use session data, to containerize 
, and to run it in a local Kubernetes cluster. You'll also learn the Open Liberty `sessionCache` 
...
You can create a named cluster group to limit the Hazelcast instances that
