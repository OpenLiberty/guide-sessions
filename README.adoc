...
a local Kubernetes cluster. When your application runs in the Kubernetes cluster environment, the application session data has to be in-sync among all instances. 
