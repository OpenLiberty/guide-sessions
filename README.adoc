...
You'll learn about Application Containerization. 
...
// *Kubernetes* +
Finally, you'll learn about Kubernetes.
...
The cluster group [hotspot=cartCluster file=1]`CartCluster` is defined in the `hazelcast-config.xml`.
