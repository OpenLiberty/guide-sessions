...
:page-description: Learn how to create and cache HTTP session data which are shared among server instances.
...
:page-seo-description: Learn how to create and cache HTTP session data which are shared among server instances.
= Caching HTTP session data to share among server instances

Learn how to create and work with HTTP session data which are shared among server instances by using Java Caching (JCache) in Open Liberty.
...
such as https://www.docker.com/[Docker^].
...
You developed an application which can share HTTP session data among server instances.
