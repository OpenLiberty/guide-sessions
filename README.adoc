...
this guide will show you how to build an application using session data, containerize the application, and run it in 
a local Kubernetes cluster. 
You'll also learn about the Open Liberty `sessionCache` feature to persist HTTP sessions using JCache and understand that the session data can be shared among pods inside the Kubernetes cluster.
