...
:page-description: Learn how to create and cache user session data between containerized applications.
...
:page-seo-description: Learn how to create and cache user session data between containerized applications.
= Caching HTTP session data in containerized applications

Learn how to create and work with user session data between containerized applications using Java Caching (JCache) in Open Liberty.
...
You'll learn about session and session caching. You'll also learn how to set
...
The containerized application that you'll be working with is a shopping cart web service. 
...
You will use a local https://openliberty.io/guides/kubernetes-intro.html#what-is-kubernetes[Kubernetes^] 
cluster to run the containerized application. 
However, you can deploy this application on any kubernetes distributions 
such as IBM Cloud or IBM Cloud Private.
...
You'll create a `cart` and `checkout` applications to store and retrieve session data.
