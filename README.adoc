...
make changes, and then you close it. The computer knows that you opened the application,
made changes, and closed the application. On the internet, however, the web server doesn't
know who you are, or what you do, because it's just processing stateless HTTP
requests. Session variables store user information like user name or items in a shopping cart.
