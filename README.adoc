...
:page-description: Learn how to create and cache non-persistent user session data between containerized applications.
...
:imagesdir: /img/guide
:page-seo-title: Caching HTTP session data in containerized applications
:page-seo-description: Learn how to create and cache non-persistent user session data between containerized applications.
= Caching HTTP session data in containerized applications

Learn how to create and work with non-persistent user session data between containerized applications using Java Caching (JCache) in Open Liberty.

== What you'll learn

You'll learn about session and session persistence theory. You'll also learn how to set
and get session data in containerized applications.
...
being routed to different backend systems or to handle failover of the backend system.
...
In this case, a user is tied to a particular server. If the server fails,
then the server session data will be lost. Session persistence can be
...
Session persistence using JCache, as illustrated, solves the above problem by allowing
...
The containerized application that you'll be working with is a shopping cart web service. You'll
