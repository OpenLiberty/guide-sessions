...
The [hotspot=library]`library` element includes the library reference that indicates
...
by using the [hotspot=group file=1]`group` configuration element in the Hazelcast configuration file.
...
Download hazelcast 5.1 from https://hazelcast.com/open-source-projects/downloads/ and run it local.
...
Install Hazelcast operator to kubernetes by https://docs.hazelcast.com/operator/latest/get-started
