...
three instances by [hotspot=replicas file=0]`replicas`, and will not route to the same instance by 
anti-affinity configration at the [hotspot=affinity file=0]`affinity` section.
...
cart-deployment-6bd97d9bf6-4ccds   1/1     Running   0          15s
cart-deployment-645767664f-nbtd9   1/1     Running   0          15s
cart-deployment-645767664f-nbtd9   1/1     Running   0          15s
----
